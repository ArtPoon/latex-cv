...
{Requested funding: \$275,000 (USD)}
{
Other principal investigators: Dr.~Zabrina Brumme, Dr.~Mark Brockman\\
The objective of this grant is to develop a phylogenetic molecular clock method to reconstruct the dates of HIV-1 integration into the latent reservoir at a lineage-specific level within a single infected host, and to characterize the dynamics of the latent reservoir using this approach.\\
I would receive \$41,850 through a sub-award through Simon Fraser University, the home university of the project leader (Dr.~Brumme).
}
